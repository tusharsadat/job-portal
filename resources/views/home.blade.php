        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-6 col-lg-3 col-md-6 text-center">
                    <img style="max-width: 200px;" src="{{ asset('assets/images/logo_mailchimp.svg') }}" alt="Image"
                        class="img-fluid logo-1">
                </div>
                <div class="col-6 col-lg-3 col-md-6 text-center">
                    <img style="max-width: 150px;" src="{{ asset('assets/images/logo_paypal.svg') }}" alt="Image"
                        class="img-fluid logo-2">
                </div>
                <div class="col-6 col-lg-3 col-md-6 text-center">
                    <img style="max-width: 120px;" src="{{ asset('assets/images/logo_stripe.svg') }}" alt="Image"
                        class="img-fluid logo-3">
                </div>
                <div class="col-6 col-lg-3 col-md-6 text-center">
                    <img style="max-width: 100px;" src="{{ asset('assets/images/logo_visa.svg') }}" alt="Image"
                        class="img-fluid logo-4">
                </div>

                <div class="col-6 col-lg-3 col-md-6 text-center">
                    <img style="max-width: 50px;" src="{{ asset('assets/images/logo_apple.svg') }}" alt="Image"
                        class="img-fluid logo-5">
                </div>
                <div class="col-6 col-lg-3 col-md-6 text-center">
                    <img style="max-width: 90px;" src="{{ asset('assets/images/logo_tinder.svg') }}" alt="Image"
                        class="img-fluid logo-6">
                </div>
                <div class="col-6 col-lg-3 col-md-6 text-center">
                    <img style="max-width: 100px;" src="{{ asset('assets/images/logo_sony.svg') }}" alt="Image"
                        class="img-fluid logo-7">
                </div>
                <div class="col-6 col-lg-3 col-md-6 text-center">
                    <img style="max-width: 90px;" src="{{ asset('assets/images/logo_airbnb.svg') }}" alt="Image"
