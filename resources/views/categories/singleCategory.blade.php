...
@section('content')
    ...
    <section class="section-hero overlay inner-page bg-image"
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-7">
                    <h1 class="text-white font-weight-bold">{{ $categoryName }}</h1>
                    <div class="custom-breadcrumbs">
                        <a href="#">Home</a> <span class="mx-2 slash">/</span>
                        <a href="#">Job</a> <span class="mx-2 slash">/</span>
                        <span class="text-white"><strong>{{ $categoryName }}</strong></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row mb-5 justify-content-center">
                <div class="col-md-7 text-center">
                    <h2 class="section-title mb-2">{{ $categoryName }}</h2>
                </div>
            </div>
            ...
            <ul class="job-listings mb-5">
                ...
                @else
                    <div class="alert alert-info" id="alert-info">
                        Under this category no job post available
                    </div>
                @endif
